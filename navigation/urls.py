...
urlpatterns = [
    ...
    path('admin-panel/faculty-edit/faculty_id=<int:faculty_id>', faculty_edit, name='faculty_edit_url'),
    path('admin-panel/faculty-delete/faculty_id=<int:faculty_id>', faculty_delete, name='faculty_delete_url'),
